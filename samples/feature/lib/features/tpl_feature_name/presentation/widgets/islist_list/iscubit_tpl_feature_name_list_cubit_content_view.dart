...
import 'iscubit_tpl_feature_name_list_cubit_view.dart';
...
class TplFeatureNameListCubitContentView extends StatelessWidget {
  const TplFeatureNameListCubitContentView({super.key});

  @override
  Widget build(BuildContext context) {
    return TplFeatureNameListCubitView(
